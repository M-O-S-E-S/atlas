...
class atKeyedBufferHandler : public atItem
{
   ...
   public:
      atKeyedBufferHandler(u_long bufferType, char * targetID, 
                           u_long bufferKey, u_char * buffer, u_long bufferLen);
      virtual ~atKeyedBufferHandler();

      void retrieveBuffer(u_long * bufferType, char ** targetID, 
                          u_long * bufferKey, u_char ** buffer, 
                          u_long * bufferLen);
      void setBuffer(u_long bufferType, char * targetID, u_long bufferKey, 
